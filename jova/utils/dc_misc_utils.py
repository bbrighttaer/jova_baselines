"""
From https://github.com/deepchem/deepchem/blob/master/deepchem/utils/__init__.py
...
__all__ = ['pad_array', 'get_data_dir', 'download_url', 'untargz_file', 'unzip_file', 'ScaffoldGenerator']
