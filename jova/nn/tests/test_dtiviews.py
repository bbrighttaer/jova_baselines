...
from jova.data.data import load_proteins
from jova.utils.args import PoolingArg, ConvArgs
from jova.utils.calc_dim import calc_1d_outdim
from proj.dti.dtiviews import EcfpView, WeaveView, GraphConvView
from jova.data import load_dti_data, DtiDataset
